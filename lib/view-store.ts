...
export type AppSection = 'DASHBOARD' | 'CHAPTER_READER' | 'FINAL_EXAM' | 'RANDOM_PRACTICE' | 'MINI_GAME' | 'ANNALES_FACULTES' | 'PRACTICAL_CASES' | 'COMMUNITY_CHAT' | 'ANATOMIE_3D' | 'PROGRESS' | 'CERTIFICATE_EXAM';
